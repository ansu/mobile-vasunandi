...
public class LandingActivity extends BaseActivity implements LandingMvpView, NavigationView.OnNavigationItemSelectedListener {
    ...
    Toolbar toolbar;
    @BindView(com.jain.vasunandisant.R.id.drawer_layout)
    DrawerLayout drawer;
    @BindView(com.jain.vasunandisant.R.id.item_list)
...
//        getMenuInflater().inflate(R.menu.landing, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.jain.vasunandisant.R.id.action_settings) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == com.jain.vasunandisant.R.id.nav_home) {
            ...
            openSubcategoryScreen("12",getString(com.jain.vasunandisant.R.string.chalisa));
        } else if (id == com.jain.vasunandisant.R.id.nav_photos) {
            openGallery("10","Gallery");
        } else if (id== com.jain.vasunandisant.R.id.nav_videos){
            openVideoLibrary("11","Videos");
        } else if (id == com.jain.vasunandisant.R.id.nav_bhajan) {
            openContentList("5","भजन");
        } else if (id == com.jain.vasunandisant.R.id.nav_aarti) {
            openContentList("3","आरती");
        } else if (id == com.jain.vasunandisant.R.id.nav_share) {
            shareArti();
        } else if (id == com.jain.vasunandisant.R.id.nav_developer_profile) {
            Intent intent = new Intent(this, DeveloperActivity.class);
            startActivity(intent);
        } else if (id == com.jain.vasunandisant.R.id.nav_contact_us) {
            Intent intent = new Intent(this, ContactUsActivity.class);
            startActivity(intent);
        }

        DrawerLayout drawer = (DrawerLayout) findViewById(com.jain.vasunandisant.R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        return true;
    }
    ...
    private void shareArti() {
        ...
        try {
            ...
            String text = getString(com.jain.vasunandisant.R.string.whats_app_share_message);
            ...
            Toast.makeText(this,getString(com.jain.vasunandisant.R.string.whats_app_notpresent_message), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    protected void setUp() {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.jain.vasunandisant.R.string.navigation_drawer_open, com.jain.vasunandisant.R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = (NavigationView) findViewById(com.jain.vasunandisant.R.id.nav_view);
    ...
    private class CategoryRecyclerViewAdapter extends
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(com.jain.vasunandisant.R.layout.category_item, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            if(mValues.get(position).getLogo()!=null && !mValues.get(position).getLogo().trim().isEmpty()) {
                Glide.with(holder.mImageView.getContext())
                        ...
                        .placeholder(com.jain.vasunandisant.R.drawable.ic_jainism)
                        .into(holder.mImageView);
            }else {
                Glide.with(holder.mImageView.getContext())
                        .load(com.jain.vasunandisant.R.drawable.side_nav_bar)
                        .placeholder(com.jain.vasunandisant.R.drawable.ic_jainism)
                        .into(holder.mImageView);
            }
