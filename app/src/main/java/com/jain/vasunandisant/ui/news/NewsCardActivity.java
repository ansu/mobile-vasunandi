...
import com.jain.vasunandisant.ui.CustomChrome.CustomTabsHelper;
import com.jain.vasunandisant.ui.base.BaseActivity;
import com.jain.vasunandisant.ui.customUiComponent.VerticalViewPager;
...
public class NewsCardActivity extends BaseActivity implements NewsCardMvpView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jain.vasunandisant.R.layout.activity_description_card);
    ...
    public void initChromeCustomTab() {
        ...
        builder.setToolbarColor(ContextCompat.getColor(this, com.jain.vasunandisant.R.color.black)).setShowTitle(true);
        // prepareMenuItems(builder);
        builder.setCloseButtonIcon(BitmapFactory.decodeResource(getResources(), com.jain.vasunandisant.R.drawable.back_icon));
...
//        builder.setExitAnimations(this, R.anim.slide_in_left, R.anim.slide_out_right);
    ...
    public void setData(List<CategoryItemData.Response> response) {
        verticalViewPager = (VerticalViewPager) findViewById(com.jain.vasunandisant.R.id.verticleViewPager);
