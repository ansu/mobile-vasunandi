...
public class ImageFullScreenActivity extends BaseActivity implements ImageFullScreenMvpView {
    ...
    @BindView(com.jain.vasunandisant.R.id.vp_full_screen_image)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jain.vasunandisant.R.layout.activity_image_full_screen);
    ...
    class CustomPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View itemView = mLayoutInflater.inflate(com.jain.vasunandisant.R.layout.fragment_full_screen_image, container, false);

            ImageView imageView = (ImageView) itemView.findViewById(com.jain.vasunandisant.R.id.iv_image_full_screen);
